...
import pranjaliBhatt from "/profile.jpg"
    ...
    >
      ...
      <div className="container relative z-10">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
          ...
          >
            ...
            <h1 className="h1 mb-4 text-foreground">
              Hi, I'm <span className="text-primary-foreground">Ashutosh Paliwal</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 mb-8">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="btn btn-outline flex items-center gap-2 p-3"
                >
        ...
        <motion.div
          ...
          className="absolute bottom-10 left-1/2 transform -translate-x-1/2 max-sm:hidden"
        >
          <a
            href="#about"
